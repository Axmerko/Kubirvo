...
class CompanyApi {
  ...
  Future<Response<BuiltList<CompanyDTO>>> apiReportCompanyCompaniesGet({
    String? filter,
    String? groupId,
    ...
    final _path = r'/api/Report/Company/Companies';
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BuiltList, [FullType(CompanyDTO)]),
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CompanyDTO>> apiReportCompanyCompaniesIdGet({
    required String id,
    String? groupId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/Report/Company/companies/{id}'.replaceAll(
        '{' r'id' '}',
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiReportCompanyDelete({
    String? subjectId,
    String? groupId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/Report/Company';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        if (groupId != null) r'group-id': groupId,
    ...
    final _queryParameters = <String, dynamic>{
      if (subjectId != null)
        r'subjectId': encodeQueryParameter(
            _serializers, subjectId, const FullType(String)),
    };
  ...
  /// Returns a [Future] containing a [Response] with a [CompanyDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CompanyDTO>> apiReportCompanyPost({
    String? groupId,
    ...
    try {
      ...
      _bodyData = companyDTO == null
          ? null
          : _serializers.serialize(companyDTO, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Returns a [Future] containing a [Response] with a [CompanyDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CompanyDTO>> apiReportCompanyPut({
    String? groupId,
    CompanyDTO? companyDTO,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
