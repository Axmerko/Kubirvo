...
import 'package:kubirovacka_api/src/model/get_delivery_note_item_dto.dart';
import 'package:kubirovacka_api/src/model/get_delivery_note_photo_dto.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'detailed_get_delivery_note_dto.g.dart';

/// DetailedGetDeliveryNoteDTO
///
/// Properties:
/// * [id]
/// * [licensePlate]
...
/// * [photos]
@BuiltValue()
abstract class DetailedGetDeliveryNoteDTO
    implements
        Built<DetailedGetDeliveryNoteDTO, DetailedGetDeliveryNoteDTOBuilder> {
  ...
  BuiltList<GetDeliveryNoteItemDTO>? get items;

  @BuiltValueField(wireName: r'photos')
  BuiltList<GetDeliveryNotePhotoDTO>? get photos;

  DetailedGetDeliveryNoteDTO._();

  factory DetailedGetDeliveryNoteDTO(
          [void updates(DetailedGetDeliveryNoteDTOBuilder b)]) =
      _$DetailedGetDeliveryNoteDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DetailedGetDeliveryNoteDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DetailedGetDeliveryNoteDTO> get serializer =>
      _$DetailedGetDeliveryNoteDTOSerializer();
}

class _$DetailedGetDeliveryNoteDTOSerializer
    implements PrimitiveSerializer<DetailedGetDeliveryNoteDTO> {
  @override
  ...
  @override
  final String wireName = r'DetailedGetDeliveryNoteDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    DetailedGetDeliveryNoteDTO object, {
    ...
    if (object.items != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType.nullable(
            BuiltList, [FullType(GetDeliveryNoteItemDTO)]),
      );
    }
    if (object.photos != null) {
      ...
      yield serializers.serialize(
        object.photos,
        specifiedType: const FullType.nullable(
            BuiltList, [FullType(GetDeliveryNotePhotoDTO)]),
      );
    }
  }
  ...
  void _deserializeProperties(
    ...
    required DetailedGetDeliveryNoteDTOBuilder result,
      ...
      switch (key) {
        ...
        case r'items':
          final valueDes = serializers.deserialize(
            ...
            specifiedType: const FullType.nullable(
                BuiltList, [FullType(GetDeliveryNoteItemDTO)]),
          ) as BuiltList<GetDeliveryNoteItemDTO>?;
          if (valueDes == null) continue;
        ...
        case r'photos':
          final valueDes = serializers.deserialize(
            ...
            specifiedType: const FullType.nullable(
                BuiltList, [FullType(GetDeliveryNotePhotoDTO)]),
          ) as BuiltList<GetDeliveryNotePhotoDTO>?;
          if (valueDes == null) continue;
  ...
  @override
  DetailedGetDeliveryNoteDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DetailedGetDeliveryNoteDTOBuilder();
