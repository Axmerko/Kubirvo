...
part 'wood_log_list_with_performance_dto.g.dart';

/// WoodLogListWithPerformanceDTO
///
/// Properties:
/// * [name]
/// * [createdAt]
...
/// * [earnings]
@BuiltValue()
abstract class WoodLogListWithPerformanceDTO
    implements
        Built<WoodLogListWithPerformanceDTO,
  ...
  WoodLogListWithPerformanceDTO._();

  factory WoodLogListWithPerformanceDTO(
          [void updates(WoodLogListWithPerformanceDTOBuilder b)]) =
      _$WoodLogListWithPerformanceDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WoodLogListWithPerformanceDTOBuilder b) =>
      b..editedFromWeb = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<WoodLogListWithPerformanceDTO> get serializer =>
      _$WoodLogListWithPerformanceDTOSerializer();
}

class _$WoodLogListWithPerformanceDTOSerializer
    implements PrimitiveSerializer<WoodLogListWithPerformanceDTO> {
  @override
  ...
  @override
  final String wireName = r'WoodLogListWithPerformanceDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    WoodLogListWithPerformanceDTO object, {
  ...
  void _deserializeProperties(
    ...
    required WoodLogListWithPerformanceDTOBuilder result,
  ...
  @override
  WoodLogListWithPerformanceDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = WoodLogListWithPerformanceDTOBuilder();
