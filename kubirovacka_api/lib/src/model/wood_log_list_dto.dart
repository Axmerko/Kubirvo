...
/// * [statusDto]
@BuiltValue()
abstract class WoodLogListDTO
    implements Built<WoodLogListDTO, WoodLogListDTOBuilder> {
  ...
  factory WoodLogListDTO([void updates(WoodLogListDTOBuilder b)]) =
      _$WoodLogListDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WoodLogListDTOBuilder b) => b..editedFromWeb = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<WoodLogListDTO> get serializer =>
      _$WoodLogListDTOSerializer();
}

class _$WoodLogListDTOSerializer
    implements PrimitiveSerializer<WoodLogListDTO> {
  @override
  final Iterable<Type> types = const [WoodLogListDTO, _$WoodLogListDTO];

  @override
  final String wireName = r'WoodLogListDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    WoodLogListDTO object, {
  ...
  void _deserializeProperties(
    ...
    required WoodLogListDTOBuilder result,
  ...
  @override
  WoodLogListDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = WoodLogListDTOBuilder();
